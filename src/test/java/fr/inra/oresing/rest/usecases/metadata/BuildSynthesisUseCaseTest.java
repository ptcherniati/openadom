...
@Tag("use-cases")
class BuildSynthesisUseCaseTest {

    @Mock
    private SynthesisService synthesisService;

    private BuildSynthesisUseCase useCase;

    @BeforeEach
    void setUp() {
        useCase = new BuildSynthesisUseCase(synthesisService);
    }
    ...
    void execute_returnsSynthesisMap() {
        ...
        when(synthesisService.buildSynthesis("app", "dataType", "variable"))
                .thenReturn(expected);
