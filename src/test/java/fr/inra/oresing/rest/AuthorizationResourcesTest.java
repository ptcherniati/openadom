...
//            Assert.assertTrue(json.contains("espece"));
    ...
    public void testAddAuthorizationOnTwoScopes() throws Exception {
...

        {
            ...
            Assert.assertEquals("{\"variables\":[],\"rows\":[],\"totalRows\":-1,\"checkedFormatVariableComponents\":{\"DateLineChecker\":{\"date_time\":{\"target\":{\"target\":{\"variable\":\"date\",\"component\":\"time\",\"id\":\"date_time\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"},\"pattern\":\"HH:mm:ss\"},\"date_day\":{\"target\":{\"target\":{\"variable\":\"date\",\"component\":\"day\",\"id\":\"date_day\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"},\"pattern\":\"dd/MM/yyyy\"}},\"ReferenceLineChecker\":{\"outil_value\":{\"target\":{\"target\":{\"variable\":\"outil\",\"component\":\"value\",\"id\":\"outil_value\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"},\"refType\":\"outil\"},\"localization_site\":{\"target\":{\"target\":{\"variable\":\"localization\",\"component\":\"site\",\"id\":\"localization_site\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"},\"refType\":\"site\"},\"localization_plateforme\":{\"target\":{\"target\":{\"variable\":\"localization\",\"component\":\"plateforme\",\"id\":\"localization_plateforme\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"},\"refType\":\"plateforme\"},\"localization_projet\":{\"target\":{\"target\":{\"variable\":\"localization\",\"component\":\"projet\",\"id\":\"localization_projet\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"},\"refType\":\"projet\"}},\"IntegerChecker\":{\"localization_profondeur\":{\"target\":{\"target\":{\"variable\":\"localization\",\"component\":\"profondeur\",\"id\":\"localization_profondeur\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"}}},\"FloatChecker\":{\"temperature_value\":{\"target\":{\"target\":{\"variable\":\"temperature\",\"component\":\"value\",\"id\":\"temperature_value\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"}},\"pression_value\":{\"target\":{\"target\":{\"variable\":\"pression\",\"component\":\"value\",\"id\":\"pression_value\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"}},\"temperature_quality\":{\"target\":{\"target\":{\"variable\":\"temperature\",\"component\":\"quality\",\"id\":\"temperature_quality\"},\"type\":\"PARAM_VARIABLE_COMPONENT_KEY\"}}}},\"entitiesTranslations\":{\"outil\":{},\"site\":{},\"projet\":{},\"plateforme\":{}}}",
                    json);
        }
    }
}