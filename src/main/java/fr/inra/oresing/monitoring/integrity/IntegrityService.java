...
public class IntegrityService {
    ...
    // Noms de colonnes / clés SQL répétés
    ...
    // Fragments SQL
    private static final String SQL_REFVALUE_WHERE_BINARYFILE =
            "\".referencevalue WHERE binaryfile = ?";
    private static final String SQL_WHERE_CORRELATION_ID =
