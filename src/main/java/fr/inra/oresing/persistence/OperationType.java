...
public enum OperationType {
    ...
    OperationType(String title, boolean display, boolean withPeriods, boolean withDataGroups, boolean forPublic, boolean forRequest,  Map<String, String> internationalizationName) {
        ...
        authorizationColumnsDescription.setForRequest(forRequest);
