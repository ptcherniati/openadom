...
class BasicComponentExampleBuilder {
    ...
    protected static final BasicComponentType HEURE = buildBasicComponents(null, BooleanExampleBuilder.TRUE, StringExampleBuilder.HEURE, TitleExampleBuilder.HEURE, DateCheckerExampleBuilder.HHMMSS, null, null);
    protected static final BasicComponentType MASSE = buildBasicComponents(null, BooleanExampleBuilder.TRUE, QUANTITE, TitleExampleBuilder.MASSE, FloatCheckerExampleBuilder.OF, DefaultValueType.FLOAT_0, null);
