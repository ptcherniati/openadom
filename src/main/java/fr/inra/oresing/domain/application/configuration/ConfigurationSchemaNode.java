...
public class ConfigurationSchemaNode {
    ...
    public static final String OA_HEADER_NAME = "OA_headerName";
    ...
    public static final String OA_MAX = "OA_max";
    public static final String OA_NAME = "OA_name";
    public static final String OA_EXPRESSION = "OA_expression";
    public static final String OA_GROOVY_EXCEPTIONS = "OA_groovyExceptions";
    public static final String OA_REFERENCES = "OA_references";
    public static final String OA_PARAMS = "OA_params";
    public static final String OA_GROOVY = "OA_groovy";
    public static final String OA_REFERENCE = "OA_reference";
    public static final String OA_IS_PARENT = "OA_isParent";
    public static final String OA_IS_RECURSIVE = "OA_isRecursive";
    public static final String OA_IS_TRUE = "OA_isTrue";
    public static final String OA_VERSION = "OA_version";
    public static final String OA_DEFAULT_LANGUAGE = "OA_defaultLanguage";
    ...
    public static final String OA_CONSTANT_IMPORT_HEADER_TARGET = "OA_importHeaderTarget";
    ...
    public static final String OA_DESCRIPTION = "OA_description";
    public static final String OA_ADDITIONAL_FILES = "OA_additionalFiles";
    public static final String OA_DATA = "OA_data";
    public static final String OA_APPLICATION = "OA_application";
    public static final String OA_MULTIPLICITY = "OA_multiplicity";
