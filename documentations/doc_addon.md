...
- La [documentation nouvelle version](fichier_de_configuration_broken.pdf) pour écrire le yaml (nouvelle version).
- Le [nouveau schema](schemaExample.yaml) pour écrire le yaml (example).
- Un [lexique des mots clef](lexique.pdf) du fichier de configuration.
- Le [format des services](services_model.html) 
