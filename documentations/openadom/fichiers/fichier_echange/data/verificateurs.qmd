...
#### OA_expression : une expression groovy (pour le checker GroovyExpression doit renvoyer true si la valeur est valide)  {#oa_expression}

#### OA_references : une liste de référentiels (ou data) pour lesquels on veut disposer des valeurs dans l'expression  {#oa_references}
