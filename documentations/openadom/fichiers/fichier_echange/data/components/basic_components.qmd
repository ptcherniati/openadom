...
classDiagram
  ...
  classDef pkClass fill:#d7e4fa,stroke:#333,stroke-width:2px
  classDef fkClass fill:#f8d7fa,stroke:#333,stroke-width:2px
  classDef parClass fill:#f4fad7,stroke:#333,stroke-width:2px
  
  class tr_type_de_sites_tds pkClass
  class tr_sites_sit fkClass
  class tr_parcelles_par parClass
```
