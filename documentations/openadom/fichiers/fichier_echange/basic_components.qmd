...
> ![](/img/warning.png) La clef du data est soumise à des restrictions. Voir la déclaration des [*identificateurs*](#identificateur)
> 
...
> ![](/img/warning.png) Il en est de même pour les clefs des components [(cf. *Identificateurs*)](#identificateur). 
...
> ![](/img/warning.png) <span style="color: orange">*OA_data* n'est pas indenté. 
