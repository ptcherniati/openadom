...
const ERRORS = {
  ...
  invalidDurationForForVariableComponentDateChecker: (params) => i18n.t("errors.invalidDurationForForVariableComponentDateChecker", params),
  ...
  invalidPatternForForVariableComponentDateChecker: (params) => i18n.t("errors.invalidPatternForForVariableComponentDateChecker", params),
  invalidPatternForForVariableComponentRegularExpressionChecker: (params) => i18n.t("errors.invalidPatternForForVariableComponentRegularExpressionChecker", params),
