          ...
          >
            <div class="column is-3-widescreen is-6-desktop is-12-tablet">
              ...
              >
                <div class="card-header">
                  ...
                  >
                    <div class="card">
                      ...
                      <div class="card-footer">
                        <div class="card-footer-item">
                          <b-button icon-left="poll" @click="displayAdditionalFileMAnagement(application)"
                ...
                <div class="card-footer is-inline-flex is-flex-direction-column">
                  <div class="card-footer-item is-inline-flex">
                    <div class="card-footer-item">
                      <b-button
