    ...
    <h1 class="title main-title">
      {{
        $t("titles.data-type-authorizations", {
          dataType: application.localName,
        })
      }}
    </h1>
    <div class="rows">
...
export default class ApplicationAuthorizationsGlobalView extends Vue {
  ...
  addAuthorization() {
    this.$router.push(`/applications/${this.applicationName}/dataTypes/authorizationsGlobal/new`);
  }

  modifyAuthorization(id) {
    this.$router.push(`/applications/${this.applicationName}/dataTypes/authorizationsGlobal/${id}`);
  }
